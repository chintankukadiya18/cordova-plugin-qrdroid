...
public class qrDroidScannerActivity extends Activity
implements SurfaceHolder.Callback {
    ...
    private void setUpCamera() {
        // If request is cancelled, the result arrays are empty.
          ...
          try {
            ...
            final Activity activityMy = this;
            //Apparently, QR Droid is not installed, or it's previous to version 3.5
            AlertDialog.Builder builder = new AlertDialog.Builder(activityMy);
            builder.setMessage( "QR Droid version 3.5 or later is required. Do you want to download or update it for free?" )
              .setCancelable(true)
             ...
             /* .setPositiveButton( "From the Market", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                  activityMy.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://market.android.com/details?id=la.droid.qr")));
                }
              })*/
              .setNeutralButton("Direct download", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                  activityMy.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://lmedia.swaminarayanbhagwan.com//mobile_api/satsangmobileapp/qrdroidscanner/download.php" ) ) );
                }
              });
            builder.create().show();
          }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
      ...
      if( ACTIVITY_RESULT_QR_DRDROID==requestCode && null!=data && data.getExtras()!=null ) {
        ...
        String qrValue = data.getExtras().getString("la.droid.qr.result");
